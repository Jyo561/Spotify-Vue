<template>
	<div class="audioList">
		...
		<div class="songsContainer">
			<div class="songs" v-for="song in Songs" :key="song" >
				<div class="count" >
					{{ song.id }}
				</div>
				<div class="song">
					<div class="imgBox">
						<img :src="song.imgSrc" alt="" @click="setSong(song)">
					</div>

					<div class="section">
						<p class="songName" @click="setSong(song)">
							{{ song.songName }}
							<span class="spanArtist">{{ song.artist }}</span>
						</p>
						<div class="hits">
							<p class="hit">
								<i><Icon icon="charm:headphones" /></i>
								95,490,102
							</p>
							<p class="duration">
								<i><Icon icon="fa6-regular:clock" /></i>
							</p>
							<div class="favourite" @click="favcha(song)">
								<i v-if="!song.favourite">
